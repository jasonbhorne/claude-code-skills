...
```
FINANCIAL_ROOT = ~/Library/CloudStorage/OneDrive-EastTennesseeStateUniversity/Personal/Financial Reports
PERSONAL_ROOT  = ~/Library/CloudStorage/OneDrive-EastTennesseeStateUniversity/Personal
```
...
| `PERSONAL_ROOT/House/*Paystub*` | `Pay Stubs/` |
| `PERSONAL_ROOT/House/JASON HORNE CHECK STUBS.pdf` | `Pay Stubs/` |
| `PERSONAL_ROOT/House/gcsstub.pdf` | `Pay Stubs/` |
| `PERSONAL_ROOT/Child Support.xlsx` | `Other/` |
| `PERSONAL_ROOT/Horne - Travel.xlsx` | `Other/` |
...
Write `/tmp/financial_dashboard_gen.py` and execute with `/opt/anaconda3/bin/python3`.
...
Write `/tmp/financial_report_gen.py` and execute with `/opt/anaconda3/bin/python3`.
...
- Use `/opt/anaconda3/bin/python3` for all Python execution.
