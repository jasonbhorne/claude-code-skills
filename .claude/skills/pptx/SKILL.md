...
# ── Color Palette (matches Horne presentation style) ─────────────
...
prs.core_properties.author = "Jason Horne"
...
def make_title_slide(title, subtitle="", context_line="", date_text=None, author="Dr. Jason B. Horne, Ed.D., MBA, SFO"):
    """
...
def make_closing_slide(title="Thank You", subtitle="Questions & Discussion",
                       body_text="", footer="", author="Dr. Jason B. Horne, Ed.D., MBA, SFO"):
    """
...
All styling is handled by the helper functions above. Design matches the Horne presentation style:
...
- Default author line: "Dr. Jason B. Horne, Ed.D., MBA, SFO"
